...
<ol>
    ...
    <li>For a serial of shape functions 
        <p>
    <img src="https://github.com/LizhengMathAi/symbol_FEM/blob/main/src/1.png" width="220" height="240" />
</p>
        ![](https://github.com/LizhengMathAi/symbol_FEM/blob/main/src/1.png) in grid element $T$ and constant arrays $(\boldsymbol{a}, \boldsymbol{b}, \cdots)$, the machine should have the ability to deduce the result of following formula
